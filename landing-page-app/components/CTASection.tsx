  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Install Draft once. Your full team context loads automatically at every session start — for every agent, every teammate, no re-explaining required.
        </p>
        ...
        >
          Free · Open source · MIT License · macOS Apple Silicon · v0.1.0
        </p>
      </div>
    </section>
  );
