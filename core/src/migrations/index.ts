...
import m20260729 from "./20260729173959_maintainer_outcome_and_proposal_dirs";

// 20260629142600_add_transcript_path (activity.db column bump) was removed:
// activity.db is no longer created or written to, so the migration was dead
// for any new install. Timestamps are never reused/renumbered, so this key
// simply disappears from the ledger rather than being reassigned.
